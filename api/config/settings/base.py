...
INSTALLED_APPS = [ 
    ...
    'apps.pedagogy.immersion',
    'apps.pedagogy.constructions',
    'apps.pedagogy.curriculum',
    'apps.pedagogy.spaced_repetition',
    'apps.pedagogy.challenges',
    'apps.governance.workflow',
